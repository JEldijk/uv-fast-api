...
DLT_HOOK_DECORATOR_RETURN = ...
DLT_DECORATOR_FUNCTION_NAMES = ...
LOCAL_EXECUTION_MODE = ...
def enable_local_execution(): # -> None:
    ...

def append_flow(name: Optional[str] = ..., target: Optional[str] = ..., comment: Optional[str] = ..., spark_conf: Optional[Dict[str, str]] = ..., once: bool = ...) -> Callable[[Callable[[], DataFrame]], None]:
    """
...
def table(query_function: Optional[Callable[..., DataFrame]] = ..., name: Optional[str] = ..., comment: Optional[str] = ..., spark_conf: Optional[Dict[str, str]] = ..., table_properties: Optional[Dict[str, str]] = ..., partition_cols: Optional[List[str]] = ..., path: Optional[str] = ..., schema: Optional[Union[StructType, str]] = ..., temporary: bool = ..., cluster_by: Optional[List[str]] = ..., row_filter: Optional[str] = ...) -> Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]:
    """
...
def view(query_function: Optional[Callable[..., DataFrame]] = ..., name: Optional[str] = ..., comment: Optional[str] = ..., spark_conf: Optional[Dict[str, str]] = ...) -> Union[Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]]:
    """
...
def on_event_hook(user_event_hook_fn: Optional[Callable] = ..., max_allowable_consecutive_failures: Optional[int] = ...): # -> Callable[[], None] | Callable[..., Callable[[], None]]:
    ...
...
def create_streaming_table(name: str, comment: Optional[str] = ..., spark_conf: Optional[Dict[str, str]] = ..., table_properties: Optional[Dict[str, str]] = ..., partition_cols: Optional[Collection[str]] = ..., path: Optional[str] = ..., schema: Optional[Union[StructType, str]] = ..., expect_all: Optional[Dict[str, Union[str, Column]]] = ..., expect_all_or_drop: Optional[Dict[str, Union[str, Column]]] = ..., expect_all_or_fail: Optional[Dict[str, Union[str, Column]]] = ..., cluster_by: Optional[List[str]] = ..., row_filter: Optional[str] = ...) -> None:
    """
...
def apply_changes(target: str, source: str, keys: Union[List[str], List[Column]], sequence_by: Union[str, Column], where: Optional[Union[str, Column]] = ..., ignore_null_updates: Optional[bool] = ..., apply_as_deletes: Optional[Union[str, Column]] = ..., apply_as_truncates: Optional[Union[str, Column]] = ..., column_list: Optional[Union[List[str], List[Column]]] = ..., except_column_list: Optional[Union[List[str], List[Column]]] = ..., stored_as_scd_type: Union[str, int] = ..., track_history_column_list: Optional[Union[List[str], List[Column]]] = ..., track_history_except_column_list: Optional[Union[List[str], List[Column]]] = ..., flow_name: Optional[str] = ..., once: bool = ..., ignore_null_updates_column_list: Optional[Union[List[str], List[Column]]] = ..., ignore_null_updates_except_column_list: Optional[Union[List[str], List[Column]]] = ..., columns_to_update: Optional[Union[str, Column]] = ...) -> None:
    """
...
def apply_changes_from_snapshot(target: str, source: str = ..., keys: Union[List[str], List[Column]] = ..., stored_as_scd_type: Union[str, int] = ..., snapshot_and_version: Callable = ..., track_history_column_list: Optional[Union[List[str], List[Column]]] = ..., track_history_except_column_list: Optional[Union[List[str], List[Column]]] = ...) -> None:
    """
